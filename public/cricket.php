 ...
 * Cricket Page
 * 
 * This file manages the cricket section of the SportSync platform.
 * Displays cricket matches filtered by status (all, live, upcoming, completed).
 * Features include match details, score displays, and favorite match functionality.
 *
 */
